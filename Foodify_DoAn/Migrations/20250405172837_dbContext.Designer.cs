...
namespace Foodify_DoAn.Migrations
{
    ...
    [Migration("20250405172837_dbContext")]
            ...
            modelBuilder.Entity("Foodify_DoAn.Data.TheoDoi", b =>
                {
                    ...
                    b.Property<int>("FollowedMaND")
                        .HasColumnType("integer");

                    b.Property<int>("FollowerMaND")
                        .HasColumnType("integer");

                    b.HasKey("Following_ID", "Followed_ID");

                    b.HasIndex("FollowedMaND");

                    b.HasIndex("FollowerMaND");
            ...
            modelBuilder.Entity("Foodify_DoAn.Data.TheoDoi", b =>
                {
                    b.HasOne("Foodify_DoAn.Data.NguoiDung", "Followed")
                        .WithMany()
                        .HasForeignKey("FollowedMaND")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Foodify_DoAn.Data.NguoiDung", "Follower")
                        .WithMany()
                        .HasForeignKey("FollowerMaND")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
